  ...
  <div class="rounded-3xl bg-black/60 border border-white/10 shadow-2xl shadow-indigo-500/20 p-10 space-y-6">
    <div class="flex items-center gap-4">
      <span class="inline-flex items-center justify-center w-12 h-12 rounded-full bg-gradient-to-br from-indigo-500 via-purple-500 to-emerald-500">
        <img src="<?= asset('../assets/images/logo.png') ?>" class="w-7 h-7" alt="logo">
      </span>
      <div>
    ...
    <div class="grid md:grid-cols-2 gap-4 text-sm text-white/70">
      ...
      <div class="p-5 rounded-2xl bg-white/5 border border-white/10">
        ...
        <a href="<?= asset('../index.php') ?>" class="block px-4 py-3 mb-2 rounded-xl bg-gradient-to-r from-indigo-500 via-purple-500 to-emerald-500 text-black font-semibold text-center">← Torna al sito</a>
        <a href="<?= asset('../logout.php') ?>" class="block px-4 py-3 rounded-xl bg-white/10 border border-white/20 text-white/80 hover:text-white text-center">Logout</a>
      </div>
    </div>
  </div>
</div>
