...
<section class="max-w-2xl mx-auto grid md:grid-cols-2 gap-8 items-center rounded-3xl p-8 bg-black/40 border border-white/10 shadow-2xl shadow-indigo-500/20">
  <div class="space-y-4">
    ...
    <p class="text-sm text-white/70">Accedi per sincronizzare i tuoi hotlap, gestire le note e prepararti alla sessione successiva.</p>
  ...
  <div class="p-6 rounded-2xl bg-white/5 border border-white/10">
    ...
    <form method="post" class="space-y-4">
      ...
      <p class="text-xs text-white/50 text-center">Non hai un account? <a href="<?= asset('register.php') ?>" class="text-emerald-300 hover:text-emerald-200">Registrati gratis</a></p>
    </form>
  </div>
</section>
