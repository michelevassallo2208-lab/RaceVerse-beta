  ...
  <div class="grid md:grid-cols-3 gap-6">
    <div class="md:col-span-2 space-y-4">
      <div class="p-6 rounded-2xl bg-white/5 border border-white/10">
        <h3 class="font-semibold text-lg mb-2">MetaVerse Pro</h3>
        <p class="text-sm text-white/70 mb-4">Accesso al download degli assetti premium, note ingegneri e consigli strategici per ogni evento.</p>
        <?php if (!Auth::isPro()): ?>
          <a href="#" class="inline-flex px-5 py-2 rounded-xl bg-gradient-to-r from-emerald-400 via-teal-400 to-cyan-400 text-black font-semibold shadow-lg shadow-emerald-500/30">Attiva abbonamento</a>
        <?php else: ?>
      ...
      <div class="p-6 rounded-2xl bg-white/5 border border-white/10">
        ...
        <p class="text-sm text-white/70">Importa i tuoi giri e confrontali con i best lap. Disponibile presto con la nuova release MetaSim Analyzer.</p>
      </div>
    </div>
    <div class="space-y-4">
      <div class="p-5 rounded-2xl bg-white/5 border border-white/10">
        ...
        <a href="mailto:support@metasim.gg" class="inline-flex px-4 py-2 rounded-xl bg-white/10 border border-white/20 text-white/80 hover:text-white">Scrivi al supporto</a>
      </div>
      <div class="p-5 rounded-2xl bg-white/5 border border-white/10">
