...
<section id="pro" class="rounded-3xl p-8 md:p-10 bg-black/40 border border-emerald-400/40 shadow-xl shadow-emerald-500/20">
  <div class="grid md:grid-cols-2 gap-8 items-center">
    <div class="space-y-4">
      ...
      <p class="text-white/70 text-lg">Un unico abbonamento per salvare i tuoi hotlap, confrontarli con i riferimenti migliori e ricevere suggerimenti operativi per la prossima sessione.</p>
      <ul class="space-y-2 text-white/80 text-sm">
        <li>• Libreria di setup condivisi dal team RaceVerse</li>
        <li>• Storico hotlap personale con andamento tempi</li>
      ...
      <div class="flex gap-3">
        ...
        <a href="<?= asset('register.php') ?>" class="px-6 py-3 rounded-2xl bg-white/10 border border-white/20 text-white/80 hover:text-white">Attiva prova</a>
      </div>
    </div>
    <div class="relative">
      ...
      <div class="relative rounded-3xl border border-white/10 bg-white/5 p-6 space-y-4 shadow-2xl shadow-emerald-500/20">
        ...
        <a href="<?= asset('register.php') ?>" class="block text-center w-full py-3 rounded-2xl bg-white text-black font-semibold">Attiva RaceVerse PRO</a>
      </div>
    </div>
  </div>
</section>
