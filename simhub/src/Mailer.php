...
class Mailer
{
    ...
    public static function sendVerificationEmail(string $toEmail, string $toName, string $verifyUrl): bool
    {
        ...
        try {
            ...
            $mailer->Subject = 'Conferma il tuo account RaceVerse';
                ...
                <div style="font-family: 'Segoe UI', Tahoma, sans-serif; background:#05060d; color:#f7f8ff; padding:32px;">
                  <div style="max-width:520px;margin:0 auto;background:linear-gradient(135deg,#101225,#1b2340);border-radius:24px;border:1px solid rgba(147,197,253,0.25);overflow:hidden;">
                    <div style="padding:28px 32px;">
                      ...
                      <p style="line-height:1.6;margin:0 0 18px;">Ciao {$toName},<br>grazie per aver creato il tuo profilo <strong>RaceVerse BASIC</strong>. Conferma l'email per iniziare a esplorare i dati e, quando vorrai, potrai passare a RaceVerse PRO (2,99€/mese).</p>
                    ...
                    <div style="background:rgba(20,25,45,0.85);padding:20px 32px;font-size:12px;color:#7d89b6;">
                      Ricevi questa email perché hai richiesto l'attivazione del tuo account RaceVerse. Per supporto scrivi a <a href="mailto:support@raceverse.it" style="color:#8ef6c0;">support@raceverse.it</a>.
                    </div>
                  </div>
                </div>
            HTML;
