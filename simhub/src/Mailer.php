...
class Mailer
{
    ...
    public static function sendNewsletterWelcome(string $toEmail, string $unsubscribeUrl): bool
    {
        try {
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background:rgba(13,24,52,0.9);border-radius:20px;padding:26px;color:#b7c8ff;">
                              <tr>
                                <td style="font-size:14px;line-height:1.8;">
                                  ...
                                  <p style="margin:12px 0;color:#ecf7ff;">Usa il codice <span style="display:inline-block;padding:6px 14px;border-radius:999px;background:rgba(88,255,226,0.12);color:#67ffe6;font-weight:600;">RACEVERSE10</span> sul tuo prossimo pass RaceVerse PRO e ottieni il <strong>10% di sconto</strong>.</p>
            ...
            $mailer->Body = $htmlBody;
            $mailer->AltBody = "Benvenuto nella newsletter RaceVerse! Usa il codice RACEVERSE10 per avere il 10% di sconto sul tuo prossimo pass PRO.\n\nSe vuoi annullare l'iscrizione visita: {$unsubscribeUrl}";
