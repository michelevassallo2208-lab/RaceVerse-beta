...
<header class="sticky top-0 z-50 bg-[#06070d]/80 backdrop-blur-2xl border-b border-white/10 shadow-lg shadow-indigo-500/10">
  <div class="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
    <a href="<?= asset('index.php') ?>" class="flex items-center gap-3 group">
      ...
      <span class="text-xl font-extrabold tracking-wide">MetaSim<span class="text-indigo-300">+</span></span>
    </a>
    <nav class="flex items-center gap-1 text-sm">
      <a href="<?= asset('index.php') ?>" class="nav-link">Home</a>
      <a href="<?= asset('index.php') ?>#selector" class="nav-link">Hotlaps</a>
      <a href="<?= asset('index.php') ?>#pro" class="nav-link">MetaVerse Pro</a>
      <a href="<?= asset('login.php') ?>" class="ml-3 px-4 py-2 rounded-xl bg-gradient-to-r from-indigo-500 via-purple-500 to-emerald-500 text-black font-semibold shadow-lg shadow-indigo-500/30 hover:shadow-purple-500/30 transition">Area Riservata</a>
    </nav>
  </div>
</header>
